...
public class BanManager {
    ...
    public void init() {
        mySQLManager.createTable("CREATE TABLE `bans` (`id` BIGINT NOT NULL AUTO_INCREMENT , `uuid` VARCHAR(255) NOT NULL , `username` VARCHAR(255) NOT NULL , `reason` VARCHAR(255) NOT NULL , `duration` BIGINT NOT NULL , `bannedby` VARCHAR(255) NOT NULL , `timestamp` TIMESTAMP NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
        mySQLManager.createTable("CREATE TABLE `mute` (`id` BIGINT NOT NULL AUTO_INCREMENT , `uuid` VARCHAR(255) NOT NULL , `username` VARCHAR(255) NOT NULL , `reason` VARCHAR(255) NOT NULL , `duration` BIGINT NOT NULL , `mutedby` VARCHAR(255) NOT NULL , `timestamp` TIMESTAMP NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;");
    }
